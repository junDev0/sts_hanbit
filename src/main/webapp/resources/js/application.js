...
var app = (function(){
	var init = function(context) {
		...
		$('#global_content_a_regist').text('SIGN UP')
		.click(function(){location.href=app.context()+'/member/regist';});
		$('#global_content_a_login').text('LOGIN')
		.click(function(){location.href=app.context()+'/member/login';});
		$('#global_content_a_admin').text('ADMIN MODE')
		.click(function(){location.href=app.context()+'/member/';}).click(function(){admin.check();});
	...
	var move = function(){
		...
		$('#a_school').click(function(){
			location.href = context()+"/member/school_info";
		});
